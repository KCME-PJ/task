                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle ms-2" href="#" role="button" data-bs-toggle="dropdown"
                            aria-expanded="false">
                            <i class="bi bi-person-fill"></i>　<?php echo $user_n['l_name']." ".$user_n['f_name']; ?>さん
                        </a>
        ...
        <div class="container-fluid">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">タスク</li>
                </ol>
            </nav>
            <span>優先順位：</span>
            ...
            <a class="btn btn-outline-success btn-sm" href="./data_log_list.php" role="button">
                <i class="bi bi-clock-history"></i> 過去ログ
            </a>
                                ...
                                <table id="task-table" class="table table-bordered">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            INNER JOIN users ON tasks.t_user_id = users.user_id
                                            ...
                                            try {
                                                ...
                                                foreach ($stmt as $row) {
                                                    ...
                                                    if (is_null($history)) {
                                                        ...
                                                        $get_id = "task_histories.php?id=$task_id";
                                                    }
                                            
                                                    print <<<EOD
                                                    <tr>
                                                        <td class="align-middle">$deadline</td>
                                                        <td class="align-middle">$f_name $l_name</td>
                                                        ...
                                                        <td class="align-middle text-center">
                                                            <a class="btn btn-outline-primary btn-sm" href="task_edit.php?id=$task_id" role="button">
