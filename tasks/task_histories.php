        ...
        <div class="container-fluid">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">進捗履歴</li>
                </ol>
            </nav>
            <?php 
                require_once '../common/database.php';
            ...
            <div>
                ...
                <a class="btn btn-outline-primary btn-sm" href="task_edit.php?id=<?php echo $task_id; ?>">
                ...
                <small class="float-end">この画面の最終更新：<?php echo $time_now; ?></small>
